...
function Dashboard() {
    ...
    const fetchHeatMapData = () => {
        fetch('https://website-backend-env.eba-6eqympxa.us-east-1.elasticbeanstalk.com/heatmap-data')
    ...
    const fetchAggregateByCountry2010_2011 = () => {
        fetch('https://website-backend-env.eba-6eqympxa.us-east-1.elasticbeanstalk.com/aggregate-by-country-2010-2011')
            .then(response => response.json())
    ...
    const fetchAggregateByCountry2009_2010 = () => {
        fetch('https://website-backend-env.eba-6eqympxa.us-east-1.elasticbeanstalk.com/aggregate-by-country-2009-2010')
            .then(response => response.json())
    ...
    const fetchTimeSeriesData = () => {
        ...
        fetch(`https://website-backend-env.eba-6eqympxa.us-east-1.elasticbeanstalk.com/retail-data-2009-2010-aggregated-timeframe?timeFrame=${aggregatedTimeFrame}&limit=1000000`)
          .then(response => {
            if (!response.ok) {
